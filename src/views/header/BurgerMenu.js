...
export const BurgerMenu = () => {
    ...
    return (
        <>
            <section className='burger-menu' onClick={() => setShow(true)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="#01204b" className="bi bi-menu-button" viewBox="0 0 16 16">
            ...
            {show ? <ResponsiveMenu close={close} /> : null}
        </>
    )
}